export default function HeroIllustration() {
  return (
    <svg viewBox="0 0 420 340" className="hero-illustration" xmlns="http://www.w3.org/2000/svg">
      <circle className="hero-orb-pulse" cx="330" cy="60" r="70" fill="var(--accent-1)" opacity="0.14" />
      <circle className="hero-orb-pulse" style={{ animationDelay: "1.5s" }} cx="50" cy="290" r="55" fill="var(--accent-2)" opacity="0.14" />

      {/* Main card */}
      <rect x="30" y="40" width="300" height="230" rx="18" fill="var(--bg-card)" stroke="var(--border-color)" />
      <circle className="hero-dot-pulse" style={{ animationDelay: "0s" }} cx="55" cy="65" r="5" fill="var(--priority-high)" />
      <circle className="hero-dot-pulse" style={{ animationDelay: "0.3s" }} cx="72" cy="65" r="5" fill="var(--priority-medium)" />
      <circle className="hero-dot-pulse" style={{ animationDelay: "0.6s" }} cx="89" cy="65" r="5" fill="var(--priority-low)" />

      {/* Ticket rows */}
      <g className="hero-row-in" style={{ animationDelay: "0.15s" }}>
      ...
      <g className="hero-row-in" style={{ animationDelay: "0.3s" }}>
      ...
      <g className="hero-row-in" style={{ animationDelay: "0.45s" }}>
